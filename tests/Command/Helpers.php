...
final class Helpers
{
     ...
     */
    public static function createStubIntrospector(
        array $tables = [],
     ...
     */
    public static function createStubConnection(): ConnectionInterface
    {
     ...
     */
    public static function executeDiffCommand(
        DiffCommand $command,
    ): array {
        ['stream' => $stream, 'output' => $output] = self::createOutputStream();
